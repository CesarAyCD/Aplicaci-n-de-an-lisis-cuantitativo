...
def load_parquet(
    ...
    # modified_ns y file_size forman parte de la clave del cache. Aunque el
    # backtest sobrescriba el mismo path, Streamlit recargará el contenido.
...
def table_number_config(df: pd.DataFrame) -> dict:
    """Aplica escalas consistentes sin convertir números a texto."""
    config = {}
    integer_terms = (
...
with tabs[5]:
    ...
    st.markdown(
        ...
        - La aplicación consume exclusivamente resultados Parquet precomputados.
        - Test no interviene en la elección de modelos ni thresholds.
        - Los modelos, thresholds y resultados se calculan por ticker y timeframe.
        - Los horizontes están medidos en barras, no necesariamente en días calendario.
        - No existen conexiones a IBKR, Yahoo Finance ni modelos en vivo en este dashboard.
        - El diseño prioriza una demostración académica estable y reproducible.
        """
    )
